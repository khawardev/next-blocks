            ...
            <section className="py-10 sm:py-16 lg:py-24">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                        <div>
                            <h1 className="text-4xl font-extrabold tracking-tigh text-black sm:text-6xl lg:text-7xl">
                            ...
                            <div className="mt-10 sm:flex sm:items-center sm:space-x-8">
                                ...
                                <a href="#" title="" className="inline-flex items-center mt-6 text-black font-semibold transition-all duration-200 sm:mt-0 hover:opacity-80">
